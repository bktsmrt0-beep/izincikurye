...
> **Not:** Her HTML/JS/CSS değişiminde `index.html` ve `admin.html`'de `?v=N` query parametresi artırılır. Commit + push → Vercel otomatik deploy ~30-60sn. Şu an `?v=114`.
...
<script src="supabase-config.js?v=113"></script>
<script src="script.js?v=113"></script>
```
Ek olarak `style.css?v=113` (her ikisi index.html ve admin.html'de).
